...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("sos", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("mlotst", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("no3os", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("po4os", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("nh4os", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("thermal_front", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("eke", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("coast_distance", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
...
for(i in 1:length(spp_list)) {
  ...
  ggsave(filename = here::here(figure_dir, paste("mean_depth", paste0(spp_list[i], ".png"), sep = "_")), 
         plot = gg, 
         width = 5,
         height = 3,
         dpi = 600)
