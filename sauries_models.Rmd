...
First, we plot the presence/absence data from the Nishikawa dataset for sauries. Generally, positive sampling points are pretty sparse.
...
Generally speaking, even with the $0-360^{\circ}$ longitude, there are still visible artefacts for the sauries' model.
