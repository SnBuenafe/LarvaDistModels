...
# Plot the longitude and latitude barplots
...
# 
# ggsave(plot = gg_full, filename = here::here(figure_dir, species, paste(species, "model1", "highconf.png", sep = "_")), width = 27, height = 15, dpi = 600)
