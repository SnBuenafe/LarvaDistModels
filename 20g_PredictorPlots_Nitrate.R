# DESCRIPTION: Summary plots for nitrate concentration
...
(skp <- plotBP(fin_tmp,
               ...
               "Skipjack tuna") +
    ylab(expression('Nitrate concentration (mmol m'^'-3'*')')) +
...
ggsave(plot = all, filename = here::here(figure_dir, "no3os_Seasonality.png"), width = 60, height = 20, dpi = 300, limitsize = FALSE)
...
ggsave(plot = all, filename = here::here(figure_dir, "ImptPredictors_no3os.png"), width = 15, height = 27, dpi = 300)
