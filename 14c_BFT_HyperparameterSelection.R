...
summary(BFT_model2) # get the relative importance of each of the predictors
...
preds <- gbm::predict.gbm(BFT_model2, test, n.trees = BFT_model2$gbm.call$best.trees, type = "response") # predict to test
