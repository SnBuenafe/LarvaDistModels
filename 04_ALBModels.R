...
CVGrid <- CVgridSearch(ALB_filtered, 5, tc = c(1, 2, 3, 5), bf = c(0.5, 0.75), lr = 0.005)
...
pres <- round(sum(ALB_sf$abundance_presence)/nrow(ALB_sf) * 100, 2)
plotPA(ALB_sf, inset, pres, "Figures/ALB_presabs.png") # Plot presence absence
