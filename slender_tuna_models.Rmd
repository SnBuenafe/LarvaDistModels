---
title: "Building slender tuna models"
author: "Tin Buenafe"
date: "`r Sys.Date()`"
output: 
  html_document:
...
18. mean probability of adult occurrence for three slender tuna species (*Cololabis saira*, *Cololabis adocetus*, and *Scomberesox saurus*)

```{r model1, echo = FALSE}
SLT_model1 <- readRDS("Output/Models/SLT_model1.rds")

print(paste0("training AUC: ", SLT_model1$self.statistics$discrimination)) # Training AUC Score
...
print(paste0("training AUC: ", SLT_model2$self.statistics$discrimination)) # Training AUC Score
