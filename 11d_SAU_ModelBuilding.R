...
ggsquished <- (ggsquish1 + ggsquish2) / (ggsquish3 + ggsquish4) +
  plot_annotation("Best model (squished); AUC: 0.93")
...
pdf(file = "Figures/SAU/SAU_model2_PredictorsTrain.pdf", width = 10, height = 8)
gbm.plot.fits(SAU_model2)
dev.off()

ggpredictors <- plotPredictors(test_tmp)
ggsave(filename = "Figures/SAU/SAU_model2_PredictorsTest.pdf", plot = ggpredictors, width = 12, height = 8, dpi = 300)
