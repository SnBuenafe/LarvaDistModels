...
(skp <- plotBP(fin_tmp,
               ...
               "Skipjack tuna") +
    ylab(expression('Chlorophyll concentration (mg m'^'-3'*')')) +
...
ggsave(plot = all, filename = here::here(figure_dir, "chlos_Seasonality.png"), width = 60, height = 20, dpi = 300, limitsize = FALSE)
