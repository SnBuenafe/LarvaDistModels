...
saveRDS(SBFT_model1, here::here(output_dir, "SBFT_model1.rds"))
# SBFT_model1 <- readRDS(here::here(output_dir, "SBFT_model1.rds"))
...
ggsave(plot = ggsquished, filename = here::here(figure_dir, "SBFT_model1_base.png"), width = 27, height = 15, dpi = 600)

gghatch <- (hatch1 + hatch2) / (hatch3 + hatch4) +
  plot_annotation(tag_levels = "a", tag_prefix = "(", tag_suffix = ")") &
  theme(plot.tag = element_text(size = 25))

ggsave(plot = gghatch, filename = here::here(figure_dir, "SBFT_model1_hatched.png"), width = 27, height = 15, dpi = 600)
...
saveRDS(SBFT_model2, here::here(output_dir, "SBFT_model2.rds"))
# SBFT_model2 <- readRDS(here::here(output_dir, "SBFT_model2.rds"))
...
ggsave(plot = ggsquished, filename = here::here(figure_dir, "SBFT_model2_base.png"), width = 27, height = 15, dpi = 600)

gghatch <- (hatch1 + hatch2) / (hatch3 + hatch4) +
  plot_annotation(tag_levels = "a", tag_prefix = "(", tag_suffix = ")") &
  theme(plot.tag = element_text(size = 25))

ggsave(plot = gghatch, filename = here::here(figure_dir, "SBFT_model2_hatched.png"), width = 27, height = 15, dpi = 600)
