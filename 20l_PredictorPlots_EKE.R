# DESCRIPTION: Summary plots for EKE
...
ggsave(plot = all, filename = here::here(figure_dir, "EKE_Seasonality.png"), width = 60, height = 20, dpi = 300, limitsize = FALSE)
