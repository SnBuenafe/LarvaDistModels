# Description: Used to calculate testing AUC
# Function adapted from dismo package
# See: https://github.com/rspatial/dismo/blob/master/R/gbm.utils.R

get_testAUC <-function (obsdat, preddat) {
