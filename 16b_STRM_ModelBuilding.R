...
saveRDS(STRM_model1, here::here(model_dir, paste(species, "model1.rds", sep = "_")))
# STRM_model1 <- readRDS(here::here(model_dir, paste(species, "model1.rds", sep = "_")))
...
saveRDS(STRM_model2, here::here(model_dir, paste(species, "model2.rds", sep = "_")))
# STRM_model2 <- readRDS(here::here(model_dir, paste(species, "model2.rds", sep = "_")))
