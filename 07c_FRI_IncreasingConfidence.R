...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("FRI", "jan-mar.csv", sep = "_"))) # save predictions
...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("FRI", "apr-jun.csv", sep = "_"))) # save predictions
...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("FRI", "jul-sept.csv", sep = "_"))) # save predictions
...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("FRI", "oct-dec.csv", sep = "_"))) # save predictions
