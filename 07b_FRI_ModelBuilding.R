...
saveRDS(FRI_model1, here::here(model_dir, paste(species, "model1.rds", sep = "_")))
# FRI_model1 <- readRDS(here::here(model_dir, paste(species, "model1.rds", sep = "_")))
...
saveRDS(FRI_model2, here::here(model_dir, "FRI_model2.rds"))
# FRI_model2 <- readRDS(here::here(model_dir, "FRI_model2.rds"))
