...
YFT_ds2 <- read_csv("Output/CSV/YFT_historical_apr-jun.csv", show_col_types = FALSE)  %>% # April-June
  restrict_predictor()
  
YFT_ds3 <- read_csv("Output/CSV/YFT_historical_jul-sept.csv", show_col_types = FALSE)  %>% # July-September
  restrict_predictor()

YFT_ds4 <- read_csv("Output/CSV/YFT_historical_oct-dec.csv", show_col_types = FALSE)  %>% # October-December
  restrict_predictor()
