# DESCRIPTION: Summary plots for surface oxygen
...
(ab_tunas <- plot_KD(df,
                      spp,
                      expression('Oxygen concentration (mol m'^"-3"*')'),
                      limits = c(NA, 0.22),
                      col_values
) +
...
ggsave(plot = all, filename = here::here(figure_dir, "ImptPredictors_o2os.png"), width = 15, height = 27, dpi = 300)
