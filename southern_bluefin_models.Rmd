---
title: "Building Southern bluefin tuna models"
author: "Tin Buenafe"
...
```{r model1, echo = FALSE}
SBFT_model1 <- readRDS("Output/Models/SBFT_model1.rds")

print(paste0("training AUC: ", SBFT_model1$self.statistics$discrimination)) # Training AUC Score
...
print(paste0("training AUC: ", SBFT_model2$self.statistics$discrimination)) # Training AUC Score
