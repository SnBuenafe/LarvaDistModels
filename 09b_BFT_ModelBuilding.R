...
ggsave(plot = ggsquished, filename = here::here(figure_dir, "BFT_model1_base.png"), width = 27, height = 15, dpi = 600)

gghatch <- (hatch1 + hatch2) / (hatch3 + hatch4) +
  plot_annotation(tag_levels = "a", tag_prefix = "(", tag_suffix = ")") &
  theme(plot.tag = element_text(size = 25))

ggsave(plot = gghatch, filename = here::here(figure_dir, "BFT_model1_hatched.png"), width = 27, height = 15, dpi = 600)
...
ggsave(plot = ggsquished, filename = here::here(figure_dir, "BFT_model2_base.png"), width = 27, height = 15, dpi = 600)

gghatch <- (hatch1 + hatch2) / (hatch3 + hatch4) +
  plot_annotation(tag_levels = "a", tag_prefix = "(", tag_suffix = ")") &
  theme(plot.tag = element_text(size = 25))

ggsave(plot = gghatch, filename = here::here(figure_dir, "BFT_model2_hatched.png"), width = 27, height = 15, dpi = 600)