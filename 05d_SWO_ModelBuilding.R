...
ggsave(file = "Figures/SWO/SWO_model2_PredictorsTrain.png", plot = ggpredictors, width = 12, height = 8, dpi = 300)

ggpredictors <- plotPredictors(test_tmp)
ggsave(filename = "Figures/SWO/SWO_model2_PredictorsTest.png", plot = ggpredictors, width = 12, height = 8, dpi = 300)
