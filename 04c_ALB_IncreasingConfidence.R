...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("ALB", "jan-mar.csv", sep = "_"))) # save predictions
...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("ALB", "apr-jun.csv", sep = "_"))) # save predictions
...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("ALB", "jul-sept.csv", sep = "_"))) # save predictions
...
gg_filt <- restrictThreshold(full_grid,
                             gg,
                             10)
saveRDS(object = gg_filt, file = here::here(preds_dir, paste("ALB", "oct-dec.csv", sep = "_"))) # save predictions
