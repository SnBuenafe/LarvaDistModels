...
# write_rds(gg, file = here::here(str_remove(figure_dir, paste0("/",species)), "FigData", paste(species, "1", "jan-mar", "highconf.rds", sep = "_")))
...
#### July-September ####
# Associate seasonal grids with the 10x10 grid
full_grid <- associateGrids(`grid_YFT_jul-sep`, grid_100)
