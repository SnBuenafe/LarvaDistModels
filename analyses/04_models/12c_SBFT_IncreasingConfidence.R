...
# Plot the longitude and latitude bar plots
bps <- plotLonLat(gg_filt, full_grid)
ggsave(plot = bps$longitude, filename = file.path(figure_dir, paste(species, "longitude", "apr-mar.png", sep = "_")), width = 7, height = 0.5, dpi = 600)
ggsave(plot = bps$latitude, filename = file.path(figure_dir, paste(species, "latitude", "apr-mar.png", sep = "_")), width = 5, height = 1, dpi = 600)
