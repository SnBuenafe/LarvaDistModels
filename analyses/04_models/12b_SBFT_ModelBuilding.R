...
SBFT_model <- dismo::gbm.step(data = train, gbm.x = brt_cols,
...
saveRDS(SBFT_model, file.path(model_dir, paste(species, "model.rds", sep = "_")))
# SBFT_model <- readRDS(file.path(model_dir, paste(species, "model.rds", sep = "_")))
