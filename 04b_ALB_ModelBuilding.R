...
saveRDS(ALB_model1, here::here(model_dir, paste(species, "model1.rds", sep = "_")))
# ALB_model1 <- readRDS(here::here(model_dir, paste(species, "model1.rds", sep = "_")))
...
saveRDS(ALB_model2, here::here(model_dir, paste(species, "model2.rds", sep = "_")))
# ALB_model2 <- readRDS(here::here(model_dir, paste(species, "model2.rds", sep = "_")))
